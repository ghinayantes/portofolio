...
export function CloudsBackground() {
  return (
    <div className="clouds-container" aria-hidden="true">
      ...
      {/* Layer 3: Depan dengan Gradasi */}
      <svg className="cloud-layer layer-3" viewBox="0 0 1440 320" preserveAspectRatio="none">
        <defs>
          <linearGradient id="cloudGrad" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="var(--cloud-grad-top)" />
            <stop offset="50%" stopColor="var(--cloud-grad-mid)" />
      ...
      {/* Layer 4: Penutup Dasar (Memastikan transisi ke Bento Grid 100% seamless) */}
      <svg className="cloud-layer" viewBox="0 0 1440 100" preserveAspectRatio="none" style={{ height: '40px' }}>
        <path fill="var(--bg-color)" d="M0,30 Q720,50 1440,30 L1440,100 L0,100 Z"></path>
      </svg>
    </div>
  );
}